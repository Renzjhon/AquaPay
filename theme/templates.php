...
<head>
    ...
    <title>Home | Perche Mini-Hardware</title>
          ...
          <div class="col-sm-6">
            <div class="contactinfo">
              <ul class="nav nav-pills">
                ...
                <li><a href="#"><i class="fa fa-envelope"></i> MarionJean@gmail.com</a></li>          
                <li><a href="admin/login.php"><i class="fa fa-lock"></i> Are you an Admin?</a></li>
